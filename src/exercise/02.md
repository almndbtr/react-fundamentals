...
- Docs: https://reactjs.org/docs/react-without-jsx.html -- there's a shorthand that you can create for `React.createElement` by caching it as a variable. This isn't something that you'd typically use for other apps, but helpful for exercises like these.
- `children` is flexible when specifying `elementProps` for a React element. Consider playing with what you can specify in each element of that array (like a whole React element versus say, just a piece of text like whitespace).
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=78528185%2Balmndbtr%40users.noreply.github.com).
